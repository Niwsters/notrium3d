...
public class KeyInputHandler{
    ...
    private void initMapping() {
    	...
    	game.getInputManager().addMapping("HRotate", new MouseAxisTrigger(MouseInput.AXIS_X, true));
    	game.getInputManager().addMapping("VRotate", new MouseAxisTrigger(MouseInput.AXIS_Y, true));
    }
}
